            ...
            <View style={styles.container}>
              ...
              <View>
                <Text style={styles.intro}>
                  ...
                  following terms govern the use of the Plantr website, and the content and services available on or
                  through the website.
                </Text>
                <Text style={styles.intro}>
                  The website is owned and operated by Plantr, and we offer its use conditional to your acceptance of
                ...
                <Text style={styles.intro}>
                  ...
                  take your use of the Plantr website after any such change has been made as your continued agreement
                ...
                <Text style={styles.content}>
                  Plantr offers a platform for users to set goals and track their achievements towards those goals. We
                  allow users to use the website to enter into binding contracts in which they Plant to meet their
                  goals (a "Plant Contract").
                </Text>
                ...
                <Text style={styles.contentSub}>
                  (b) the information provided by you to Plantr, during registration process and in your subsequent use
                ...
                <Text style={styles.contentSub}>
                  We may delete your account and/or deny you any and all current or future use of the Plantr service if
                ...
                <Text style={styles.contentSub}>
                  To maintain the sanctity of your account, you hereby agree to immediately notify Plantr of any
                ...
                <Text style={styles.contentSub}>
                  ...
                  reason whatsoever. You, however, understand that if you have an on-going Plant Contract at the time
                  of your termination, you will continue to be constrained by the terms of that Plant Contract until
                  that Plant Contract ends.
                </Text>
                <Text style={styles.contentSub}>
                ...
                <Text style={styles.contentSub}>
                  ...
                  Plantr. You hereby accept that the website and its contents are designed and presented by us in a
                ...
                <Text style={styles.contentSub}>
                  Plantr, www.Plantrapp.io, its logo, service marks, trademarks, and graphics used as it relates to
                  this website are registered trademarks of Plantr. Other logos, service marks, trademarks, and
                  graphics used in and on this website may be the trademarks of other third parties.
                </Text>
                <Text style={styles.contentSub}>
                  Your use of the Plantr website does not grant you the right or license to replicate or otherwise use
                  any Plantr or third-party trademarks.
                </Text>
                ...
                <Text style={styles.contentSub}>
                  ...
                  In no event will Plantr be liable for any omissions or mistakes in any content, any damage or loss of
                ...
                <Text style={[styles.content, {marginTop: ms(25)}]}>
                  ...
                  entity or individual as decided by Plantr, and you may not submit/upload false content or the one
                  that breaches the rights of others, including patents, trade secrets trademarks, copyrights, and
                  publicity or privacy rights.
                </Text>
                <Text style={styles.contentSub}>
                  Your content must not harm or seek to in any way harm minors, and may not imply that you a Plantr
                ...
                <Text style={styles.contentSub}>
                  ...
                  Plantd relationships or any other law.
                </Text>
                <Text style={styles.contentSub}>
                  You are not to provide advertisements, solicitations or spam links to other web sites or individuals,
                  without prior written permission from Plantr; chain letters or pyramid schemes; or content that
                  imitates another business, entity or person, including Plantr, its related entities, employees and
                  agents.
                </Text>
                <Text style={styles.contentSub}>
                ...
                <Text style={styles.contentSub}>
                  You may not collect other users’ information or content, or otherwise, access Plantr using harvesting
                ...
                <Text style={styles.contentSub}>
                  ...
                  indemnify Plantr and its affiliates for all and any claims ensuing from any content that you make
                  available.
                </Text>
                <Text style={styles.contentSub}>
                  ...
                  discretion, exercise our right to move, revise, or remove any content posted on Plantr for any
                ...
                <Text style={styles.content}>
                  The website, the website content, and our services are made available "as-is" and Plantr disclaims
                ...
                <Text style={styles.contentSub}>
                  ...
                  us, by third parties, by other Plantr users, or by programming or equipment related to the website.
                </Text>
                <Text style={styles.contentSub}>
                ...
                <Text style={styles.contentSub}>
                  Under no circumstances will Plantr be liable for any damage or loss, including any damage or loss to
                  any user content or personal injury or death that may occur as a result of your use of the services.
                </Text>
                <Text style={styles.contentSub}>
                  Plantr does not warrant or represent that the materials, content, or software found on the website
                ...
                <Text style={styles.contentSub}>
                  Plantr is not a medical or psychological organization, and you may not take anything on this website
                ...
                <Text style={styles.contentSub}>
                  Plantr cannot guarantee, nor does it, give any assurance or warranties as to the specific results
                  obtained from the website's use.
                </Text>
                <Text style={styles.contentSub}>
                  Under no circumstances will Plantr or its owners, managers, staff or agents be held accountable for
                  ...
                  your use of the website, even if Plantr has been made aware of the likelihood of such damages.
                </Text>
                <Text style={styles.contentSub}>
                  We will not be held accountable for any situation whose occurrence was beyond our control that may
                  cause the Plantr services to be late, interrupted, or corrupt; any hurts, losses, or damages of any
                  type arising as it relates to, or as a consequence of, using Plantr.
                </Text>
                <Text style={styles.contentSub}>
                ...
                <Text style={styles.content}>
                  You and Plantr agree that all disputes that may arise, however arising, between both of us or in
                ...
                <Text style={styles.content}>
                  ...
                  (including but not limited to legal fees), and damages in connection with the Plantr website usage.
                  You also agree to so shield, indemnify, and hold Plantr innocent for all damages resulting from your
                ...
                <Text style={styles.content}>
                  The failure of Plantr to implement or exercise any condition or right of these terms shall not be
                ...
                <Text style={styles.titleContentModal}>Entire Agreement and Relationship with any Plant Contract</Text>
                <Text style={styles.contentFooter}>
                  While these terms and conditions represent the entire agreement between you and Plantr regarding the
                  use of the website, and even though it supersedes any prior agreements you may have, you accept that
                  it does not supersede any Plant Contracts between you and Plantr.
                </Text>
              </View>
            </View>
          </ScrollView>
