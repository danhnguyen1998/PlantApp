...
export default function AddCommitmentPaymentComponent(props: IProps) {
  ...
  const _continue = async (card_id, four_digit_card) => {
    ...
    props.paymentAction(card_id, four_digit_card);
      ...
      {/* <Header
        leftComponent={
          <TouchableOpacity onPress={_goBack} style={styles.headerLeftTouch}>
            <Icon name="chevron-left" size={ms(15)} />
          </TouchableOpacity>
        }
        centerComponent={{
