...
export default function TAndCComponent(props: IProps) {
    ...
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.viewContainer}>
          ...
          <Text style={styles.intro}>
            This agreement contains important information about your legal rights and obligations and remedies you may
            seek. This agreement also contains important information about allowable exclusions and limitations and how
            we handle dispute resolutions.
          </Text>
          ...
          <Text style={styles.content}>
            While visitors are welcome to browse through the website, you will be prompted to fill out a registration if
            you desire to gain access to/use some portions of our website. This registration process will require that
            you divulge private information such as your full name and applicable contact details.
          </Text>
          ...
          <Text style={styles.contentSub}>
            (c) you are not a person barred from receiving comparable services to ours under United States law or under
          ...
          <Text style={styles.contentSub}>
            Upon completion of the registration process, you will receive or will be prompted to choose a user name and
            password. You accept that the responsibility for maintaining the security and confidentiality of the
            password and account is yours.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.contentSub}>
            ...
            for any other reason, except we issue you a written consent to do that.
          </Text>
          <Text style={styles.contentSub}>
            You agree, warrant and represent that no materials of any type that you submit through your account or that
            you otherwise post, share, or transmit through the website will breach or overstep the rights of any third
            party, including personal or proprietary, publicity, privacy, copyright, trademark or other rights.
          </Text>
          <Text style={styles.title}>Duration of this Agreement</Text>
          <Text style={styles.content}>
            These terms and conditions will remain fully in force and be effective while you use the website as a
            registered user. You, however, understand that we have the right to delete your profile, terminate your
            membership, and to delete any information or content posted by you on the website for any reason whatsoever.
          </Text>
          <Text style={styles.contentSub}>
            We may also bar you from using or accessing any feature, aspect or portion of the website for no or any
            reason, and we may do this with or without notice, based only on our sole discretion.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.title}>Intellectual Property and Proprietary Rights</Text>
          <Text style={styles.content}>
            ...
            all and any software programs provided via the website, are trademarked and copyrighted. With no exception,
            they are all protected by intellectual property laws, except we have explicitly indicated so to the
            contrary.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.content}>
            ...
            upload, reproduce or distribute any service marks, trademarks, or copyrighted material or other proprietary
            information that another party owns.
          </Text>
          <Text style={styles.contentSub}>
            Where you believe that your work was copied and posted on the website without your permission or in any
            other way that might be deemed copyright infringement, make sure to review the procedures that we have
            explained under our copyright policy.
          </Text>
          <Text style={styles.contentSub}>
            In our bid to adhere to the Digital Millennium Copyright Act (DMCA) and other relevant law, it is our policy
            to terminate the accounts of members who are considered as repeat infringers.
          </Text>
          <Text style={styles.contentSub}>
            At our discretion, we may also restrict access to the website and/or stop the access of users who violate
            the memberships of other users, even where there has been no repeat infringement or infringement of the
          ...
          <Text style={styles.contentSub}>
            An identification of the allegedly infringing material alongside enough information to permit us to locate
            the material;
          </Text>
          ...
          <Text style={styles.contentSub}>
            A good faith statement that you are the owner, or that you are authorized to act on behalf of the owner, of
            the copyright that is allegedly infringed; and
          </Text>
          <Text style={styles.contentSub}>Your legal name and electronic or physical signature.</Text>
          <Text style={styles.title}>User Content and Conduct</Text>
          <Text style={styles.content}>
            Registered users are allowed to publicly post or privately transmit content (which may include data, text,
            photographs, information, graphics, or other materials) on the website. It is important to understand that
          ...
          <Text style={styles.contentSub}>
            We may monitor user-provided content for unauthorized and/or illegal activity, but we are not obligated to
            do so.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.contentSub}>
            ...
            content has clearly granted us a universal, nonexclusive, unlimited, irreversible, continuous, royalty-free,
            license to create derivative works from, adapt, display, perform, distribute, convert, edit, issue,
            replicate, and use the material in any way, through any media, and in any manner.
          </Text>
          <Text style={styles.contentSub}>
            It is very important that you understand that it is better to never submit any user content that you are not
            willing to license to us, as you understand that we are under no obligation to maintain the confidentiality
            of any content, to respond to any user content, or to pay compensation for the use of any content.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.contentSub}>
            ...
            other users’ ability to carry out real-time exchanges; or interferes with or disrupts the Service or
            networks or servers associated with the Service.
          </Text>
          <Text style={styles.contentSub}>
            You are barred from posting content containing viruses or other damaging computer codes, or content that
            oppresses degrades, hassles, or threatens a person/group of persons based on ethnicity, race, disability,
          ...
          <Text style={styles.contentSub}>
            You hereby agree that you will always evaluate, and consequently take on all the associated risks as per the
            use of any website-provided content, including any dependence on the usefulness, accuracy, or completeness
            of such content.
          </Text>
          ...
          <Text style={styles.contentSub}>
            All downloads and obtainment of software, data, material, or content from or through the website are done at
            your own risk and discretion, and we will not be liable to you for any damage, if any, to your computer
            system or mobile device, or for the loss of data, or any other experienced harm of any kind.
          </Text>
          <Text style={styles.contentSub}>
          ...
          <Text style={styles.contentSub}>
            ...
            not limited to maintenance. We will not bear any responsibility to you for any delay, defect, deletion,
            interruption, omission, or error that you may encounter in operation or transmission, communications line
            failure, theft or destruction or unauthorized access to, or alteration of, user communications including but
          ...
          <Text style={styles.contentSub}>
            ...
            unpredictable harms or misfortunes.
          </Text>
          <Text style={styles.contentSub}>
            No provision of this legal document is planned to exclude or restrict our culpability for injury or for
            death arising from our carelessness and deception, as well as for other liabilities that are not to be
            restricted or exempted by law, or that are aimed at restricting your constitutional rights as a consumer.
          </Text>
          <Text style={styles.contentSub}>
            Should the applicable law of your jurisdiction not permit the restriction of liability herein explained,
            this limitation of liability will not apply to you.
          </Text>
          <Text style={styles.title}>Links to other Resources</Text>
          <Text style={styles.content}>
            We are not liable for the content of any off-site resources or any other websites linked to or from the
            website. Links found on the website have been put there for the convenience of users and are not a
            commendation or recommendation by us, our associates, or our partners of the supplier, service, product, or
            content of such a link.
          </Text>
          <Text style={styles.contentSub}>
            When you link to or from any websites that are not ours, you do so at your own risk. We do not have the
            responsibility of, and will not be liable to you for evaluating or examining the offerings, content,
            product, service, or policies of such off-website pages.
          </Text>
          <Text style={styles.contentSub}>
            We do not assume any liability or responsibility for the offerings, content, product, service, or policies
            of these pages and advise that you very carefully read and review their terms of use as well as their policy
            statements and all other referenced policies before you use them.
          </Text>
          ...
          <Text style={styles.contentSub}>
            ...
            arbitrated on an individual basis. Disputes brought to arbitration may not be joined or consolidated in
          ...
          <Text style={styles.title}>No agency</Text>
          <Text style={styles.content}>
            This agreement does not create or form any franchisor-franchisee, employer, partnership, agency, or joint
            venture between you and us in any way.
          </Text>
          ...
          <Text style={styles.content}>
            ...
            the agreement will remain binding upon both parties.
          </Text>
          ...
          <Text style={styles.content}>
            This legal agreement is governed by laws of the United States, and you consent to submit to the jurisdiction
            of its courts.
          </Text>
          <Text style={styles.title}>Survival</Text>
          <Text style={styles.content}>
            All terms and provisions of this agreement, which by their very nature are billed to survive any termination
            of this agreement shall so survive any such termination.
          </Text>
          <Text style={styles.contentSub}>
